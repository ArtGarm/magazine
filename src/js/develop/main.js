...
$(document).ready(function(){
    ...
    /* single */
        ...
        if ( $('.single-wrap').length ){
            ...
            $('.tabs .head-tabs li').on('click', function(){
                if ( !$(this).hasClass('active') ){
                    $('.tabs .content-tabs li').eq( $('.tabs .head-tabs li.active').index() ).slideUp(300)
                    $('.tabs .head-tabs li').removeClass('active');
                    $(this).addClass('active');
                    $('.tabs .content-tabs li').eq( $(this).index() ).slideDown(300);
                } 

            });

            $('.side-images .left-slider').slick({
                slidesToShow: 3,
                slidesToScroll: 1,
                asNavFor: '.side-images .slider-center',
                dots: false,
                centerMode: true,
                focusOnSelect: true,
                vertical: true,
            ...
            $('.side-images .slider-center').slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                arrows: false,
                fade: true,
                asNavFor: '.side-images .left-slider'
            });
